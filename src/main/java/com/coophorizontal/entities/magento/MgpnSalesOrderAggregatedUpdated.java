 ...
 */
@Entity
@Table(name = "mgpn_sales_order_aggregated_updated")
@NamedQueries({
    @NamedQuery(name = "MgpnSalesOrderAggregatedUpdated.findAll", query = "SELECT m FROM MgpnSalesOrderAggregatedUpdated m")})
public class MgpnSalesOrderAggregatedUpdated implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof MgpnSalesOrderAggregatedUpdated)) {
            return false;
        }
        MgpnSalesOrderAggregatedUpdated other = (MgpnSalesOrderAggregatedUpdated) object;
    ...
    public String toString() {
        return "com.cooperacionhorizontal.entitycreator.MgpnSalesOrderAggregatedUpdated[ id=" + id + " ]";
    }
